    ...
    <main className="max-w-4xl p-3 mx-auto">
        ...
        <form className="flex flex-col gap-4 sm:flex-row">
            <div className="flex flex-col flex-1 gap-4">
                ...
                <textarea type="text" placeholder="Description" className="p-3 border rounded-lg" id="description" required/>
            ...
            <div className="flex flex-col flex-1 gap-4">
                ...
                <div className="flex gap-4">
                    ...
                    <button className="p-3 text-green-700 uppercase border border-green-700 rounded hover:shadow-lg disable:opacity-80">Upload</button>
                </div>
            </div>
